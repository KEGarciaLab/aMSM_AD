...
SUBJECT_TXT=${HOME}/Scripts/MyScripts/Output/Ciftify_Subject_List.sh/subject_numbers_2025-04-08_15-50-17.txt #List of subjects to run, ensure you have ran Ciftify_Subject_List.sh and are pointng to the correct file
