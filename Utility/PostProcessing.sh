...
######### CHANGE AS NEEDED
DATASET=/N/project/aMSM_AD/ADNI/HCP/MSM_T1W # Folder containing subject data
IMAGE_DIR=/N/project/aMSM_AD/ADNI/HCP/POST_PROCESSING_T1W # Location to copy all images to
