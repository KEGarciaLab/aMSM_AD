...
######### CHANGE AS NEEDED
DATASET=/N/project/aMSM_AD/ADNI/HCP/MSM_T1W_ANATCONFIG # Folder containing subject data
IMAGE_DIR=/N/project/aMSM_AD/ADNI/HCP/POST_PROCESSING_T1W_ANATCONFIG # Location to copy all images to
...
for DIR in ${REVERSE_DIRS[@]}; do
    ...
    L_SURFACE_MAP=${SUBJECT}_L_${TIME1}-${TIME2}.surfdist.CPgrid.func.gii
    R_SURFACE_MAP=${SUBJECT}_R_${TIME1}-${TIME2}.surfdist.CPgrid.func.gii
    L_INVERSE_SURFACE_MAP=${SUBJECT}_L_${TIME1}-${TIME2}.surfdist.CPgrid.inverse.func.gii
    R_INVERSE_SURFACE_MAP=${SUBJECT}_R_${TIME1}-${TIME2}.surfdist.CPgrid.inverse.func.gii
    SPEC_FILE=${DIR}/${SUBJECT}_${TIME1}-${TIME2}.spec
    echo "FILES RETRIEVED:"
    echo ${L_YOUNGER_SURFACE}
    echo ${L_OLDER_SURFACE}
    ...
    sed "s!SURFACE_PATH!${DIR}!g;s!L_YOUNGER_SURFACE!${L_YOUNGER_SURFACE}!g;s!L_OLDER_SURFACE!${L_OLDER_SURFACE}!g;s!L_SURFACE_MAP!${L_INVERSE_SURFACE_MAP}!g;s!R_YOUNGER_SURFACE!${R_YOUNGER_SURFACE}!g;s!R_OLDER_SURFACE!${R_OLDER_SURFACE}!g;s!R_SURFACE_MAP!${R_INVERSE_SURFACE_MAP}!g;" ${IMAGE_DIR}/base-reverse_inverted.scene > ${DIR}/${SUBJECT}_${TIME1}-${TIME2}_INVERTED.scene
    sed "s!SURFACE_PATH!${DIR}!g;s!L_YOUNGER_SURFACE!${L_YOUNGER_SURFACE}!g;s!L_OLDER_SURFACE!${L_OLDER_SURFACE}!g;s!L_SURFACE_MAP!${L_INVERSE_SURFACE_MAP}!g;s!R_YOUNGER_SURFACE!${R_YOUNGER_SURFACE}!g;s!R_OLDER_SURFACE!${R_OLDER_SURFACE}!g;s!R_SURFACE_MAP!${R_INVERSE_SURFACE_MAP}!g;" ${IMAGE_DIR}/base-reverse_inverted_no-scale.scene > ${DIR}/${SUBJECT}_${TIME1}-${TIME2}_INVERTED_NO-SCALE.scene
    echo "SCENE WITH SCALE COMPLETE. SAVED AT: ${DIR}/${SUBJECT}_${TIME1}-${TIME2}.scene"
    echo "SCENE WITHOUT SCALE COMPLETE. SAVED AT: ${DIR}/${SUBJECT}_${TIME1}-${TIME2}_NO-SCALE.scene"
